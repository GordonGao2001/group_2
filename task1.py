...
def validate_extracted_answer(question, raw_answer, extracted_answer):
    ...
    1. A question.
    2. A raw answer generated by Llama
    3. An extracted answer, the answer can be yes/no or a wikipedia entity with a link
    Your task is to determine if the extracted answer is correct or not based on the raw answer and the question. 
...
for question_id, question_text in q_list:
   ...
   # print(f"****************delete me after publish*********:{question_id}")
    if q_types[int(question_id[-3:]) - 1] == 1:  # yes/no case
        ...
        result = validate_extracted_answer(question_text,raw_answer,my_extract)
